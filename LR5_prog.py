...
def fuzzy_search(user_query, products):
    #Создание словаря для хранения расстояния для каждого товара
    #Ключ = название товара
    #Значение = минимальное расстояние до него
    best_matches = {}
    ...
    for i in user_query:
        for item in products:
            ...
            dist = levenstein(i_low, item_low)
    ...
    #Превращаем словарь в список кортежей и сортируем по расстоянию
